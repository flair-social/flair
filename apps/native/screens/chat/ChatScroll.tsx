...
const messages = [
  ...
  {
    user: "Djolanoouille",
    message: "Vous : A quelle heure au duplex du coup ?"
  },
  { user: "Naps", message: "Naps : C'est la kiffance !" },
  { user: "Benoit paire", message: "Aurélien : Qui y arrive pour l'auth ?" },
  {
    user: "Newwave",
    message: "BenzJ : J'adore R2D2 sur la nouvelle prod NewJazz"
  },
  { user: "Martin matin", message: "Vous : pk tu rep plus ?" },
  {
    user: "PouletAnanas",
    message: "landry : façon les blancs vous savez pas mettre d'épices"
  },
  {
    user: "Dézingueur2Folles93",
    message: "AD : On se revoit le prochain 20 Avril ?"
  },
